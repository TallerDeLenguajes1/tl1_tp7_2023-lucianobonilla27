El parámetro --output en el comando dotnet new console --output se utiliza para especificar la ubicación o directorio donde se generará el proyecto de consola.
